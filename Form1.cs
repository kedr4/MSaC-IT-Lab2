namespace MSaC_IT_Lab2
{
    public partial class Form1 : Form
    {
        ...
        {
            CodeComplexityAnalyzer analyzer = new CodeComplexityAnalyzer();

            string codeContent = codeRichTextBox.Text;

            analyzer.Analyze(codeContent);

            analyzer.DisplayMetricsInRichTextBox(resultRichTextBox);
        }
